...
winking
surprised
rejoicing (subtle, minimal gesture allowed)
confused
confident / sassy
...
Have crisp, sticker-like edges with a thin white outline
...
Keep expressions clear, readable, and visually distinct using only facial features (eyes, eyebrows, mouth, slight head tilt)`;
