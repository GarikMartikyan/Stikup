      ...
      <main className="snap-section relative mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-5 py-6 md:py-10">
        ...
        <div className="reveal mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-base text-[var(--color-fg-muted)] md:text-lg">
            All 12 stickers installed under your Telegram account. Tap to add
            them to your sticker tray.
          </p>
        </div>
        ...
        <section className="mt-6 grid gap-3 md:mt-8 md:grid-cols-3 md:gap-4">
          <NextCard
            ...
            body="Drop a sticker into a video and tag #stikup. Your pack travels."
            cta="Open share"
          />
          <NextCard
            icon={Gift}
            title="Invite a friend"
            body="They make a paid pack → you get 2 bonus stickers added to yours."
            cta="Copy referral link"
          />
          <NextCard
            icon={Sparkles}
            title="Make another"
            body="Different photo, fresh 12 stickers. Single $5.99 — no subscription."
            cta="Start new pack"
          />
        </section>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-dashed border-[var(--color-border-strong)] p-4 text-sm text-[var(--color-fg-muted)] md:mt-8">
          <div className="flex items-center gap-2">
            ...
            <span>Thanks for trying Stikup.</span>
          </div>
          <Link
            href="/dashboard"
